...
export const Icons = {
  sun: SunMedium,
  moon: Moon,
  logo: ({ alt = 'Logo', ...rest }: LucideProps & { alt?: string }) => {
    // Example of explicitly setting properties. Adjust as needed.
    const imgProps = {
      alt,
      style: { width: '50px', height: '50px' }, // Adjust size as needed
      // Add any other props you want to explicitly pass to the img tag
    };
    return (
      <img
        src="./Untitled_design__1_-removebg-preview.png"
        {...imgProps}
        // Optionally, handle or transform any other props as needed
      />
    );
  },
}
